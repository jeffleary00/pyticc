...
cc.register_write('AGCCTRL2', 'MAX_LNA_GAIN[2:0]', '100')
cc.register_write('AGCCTRL2', 'MAX_DVGA_GAIN[1:0]', '01')
...
cc._register_write('PKTCTRL1', 'CRC_AUTOFLUSH', 0x00)
cc._register_write('DEVIATN', 'DEVIATION_E', 0x06)
cc._register_write('DEVIATN', 'DEVIATION_M', 0x02)

cc._register_write('IOCFG2', 'GDO2_CFG', 0x0B)
cc._register_write('IOCFG0', 'GDO0_CFG', 0x0C)
cc._register_write('PKTCTRL0', 'CRC_EN', 0x00)
cc._register_write('FSCTRL1', 'FREQ_IF', 0x06)
cc._register_write('FSCTRL1', 'FREQ_IF', 0x06)
cc._register_write('MDMCFG2', 'SYNC_MODE[2:0]', 0x00)
cc._register_write('AGCCTRL0', 'FILTER_LENGTH', 0x02)
cc._register_write('AGCCTRL2', 'MAGN_TARGET', 0x02)
"""
